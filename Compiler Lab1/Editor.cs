...
namespace Compiler_Lab1
{
    public partial class textEditor : Form
    {
        ...
        private void CallHelp()
        {
            ...
            {
                MessageBox.Show($"{_localization.Get("HelpOpenError")}: {ex.Message}", "ќшибка",
                    MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
    ...
    : DragDropEffects.None;
        ...
        private void UpdateStatusInfo(TabPage tab)
        {
            ...
            string language = _localization.CurrentLanguage == "ru" ? "–усский" : "English";
        ...
        private void RunSyntaxAnalysis()
        {
            ...
            if (parser.Errors.Count == 0)
            {
                dgvResults.Rows.Add(
                    "",
                    "",
                    "—интаксический анализ завершЄн успешно"
                );
            }
        }
