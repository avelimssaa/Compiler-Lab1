namespace Compiler_Lab1
{
    partial class About
    {
        ...
        private void InitializeComponent()
        {
            ...
            labelProductName.Text = "Название продукта - Текстовый редактор";
            ...
            labelCopyright.Text = "Авторские права - Зенцов Вадим, АВТ-313";
            ...
            labelCompanyName.Text = "Название организации - НГТУ НЭТИ";
            ...
            textBoxDescription.Text = "Описание\r\nТекстовый редактор, сделанный в ходе первой лабораторной работы по дисциплине\r\n\"Теория формальных языков и компиляторов\". Создатель продукта - студент \r\nЗенцов Вадим, группа АВТ-313.\r\n";
            // 
            // okButton
            // 
