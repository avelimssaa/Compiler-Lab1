...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_TOKEN_PRINTLN = 3,              /* TOKEN_PRINTLN  */
  YYSYMBOL_TOKEN_IDENTIFIER = 4,           /* TOKEN_IDENTIFIER  */
  YYSYMBOL_TOKEN_FOR = 5,                  /* TOKEN_FOR  */
  YYSYMBOL_TOKEN_TO = 6,                   /* TOKEN_TO  */
  YYSYMBOL_TOKEN_LPAREN = 7,               /* TOKEN_LPAREN  */
  YYSYMBOL_TOKEN_RPAREN = 8,               /* TOKEN_RPAREN  */
  YYSYMBOL_TOKEN_LBRACE = 9,               /* TOKEN_LBRACE  */
  YYSYMBOL_TOKEN_RBRACE = 10,              /* TOKEN_RBRACE  */
  YYSYMBOL_TOKEN_SEMICOLON = 11,           /* TOKEN_SEMICOLON  */
  YYSYMBOL_TOKEN_ARROW = 12,               /* TOKEN_ARROW  */
  YYSYMBOL_TOKEN_NUMBER = 13,              /* TOKEN_NUMBER  */
  YYSYMBOL_TOKEN_SPACE = 14,               /* TOKEN_SPACE  */
  YYSYMBOL_TOKEN_TAB = 15,                 /* TOKEN_TAB  */
  YYSYMBOL_TOKEN_NEWLINE = 16,             /* TOKEN_NEWLINE  */
...
{
  "\"end of file\"", "error", "\"invalid token\"", "TOKEN_PRINTLN",
  "TOKEN_IDENTIFIER", "TOKEN_FOR", "TOKEN_TO", "TOKEN_LPAREN",
  "TOKEN_RPAREN", "TOKEN_LBRACE", "TOKEN_RBRACE", "TOKEN_SEMICOLON",
  "TOKEN_ARROW", "TOKEN_NUMBER", "TOKEN_SPACE", "TOKEN_TAB",
  "TOKEN_NEWLINE", "TOKEN_ASSIGN", "TOKEN_ERROR", "$accept", "program",
  "token", YY_NULLPTR
};
...
{
       2,     0,     1,     5,     7,     4,     6,     9,    10,    11,
      12,    13,    14,     8,    16,    18,    17,    15,    19,     3
};
